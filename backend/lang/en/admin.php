...
return [
    ...
    'tasks' => [
        ...
        'reorder_denied'          => 'Some cards were left where they were',
        'reorder_denied_body'     => ':count card(s) are not yours to move — you can only reorder tasks you are assigned to or supervise.',
        'priority'    => 'Priority',
        'category'    => 'Category',
        'parent'      => 'Parent task',
        'is_private'      => 'Private task',
        'is_private_help' => 'Off the board for everyone except the admins and the people on this task. Admins only.',
        'private_badge'   => 'Private',
        'only_private'    => 'Private only',
        ...
        'subtask_not_allowed' => 'You do not have permission to add or remove subtasks.',
        'comment_not_allowed' => 'You can only edit or remove your own comments on a task you are on.',
        'proof_not_allowed' => 'You can only edit or remove documentation you posted yourself.',
        'priorities'  => [
            'urgent' => 'Urgent',
            'high'   => 'High',
            'normal' => 'Normal',
    ...
    'applications' => [
        ...
        'role_help' => 'Required, and deliberately blank to start — pick it rather than accept a default. Member is the right answer for almost everyone: their own tasks, the roster, the inventory. Manager adds content and team editing; Admin is unrestricted. It can be changed later under Users.',
    ...
    'team' => [
        ...
        'identity_locked' => 'Only an administrator can change the addresses and the linked account — they decide who signs in and where password mail is delivered.',
        ...
        'delete_with_login_body' => 'This also deletes their panel account (:login) — they will no longer be able to sign in. The account is not restored if you undo this.',
        'delete_bulk_with_login_body' => 'This also deletes the panel accounts of the selected members — they will no longer be able to sign in. Your own account and any admin account are left alone.',
        'joined_at'      => 'Joined at',
        'left_at'        => 'Left at',
        'left_at_help'   => 'Set when the member leaves the team — keeps history without deleting the row.',
        'is_part_time'            => 'Part-time',
        'is_part_time_help'       => 'Everyone is full-time unless this is on. Independent of role and of alumni status — someone can be part-time in any position.',
        'is_part_time_col'        => 'Commitment',
        'part_time_badge'         => 'Part-time',
        'part_time_filter'        => 'Commitment',
        'part_time_filter_all'    => 'Everyone',
        'part_time_filter_part'   => 'Part-time only',
        'part_time_filter_full'   => 'Full-time only',
        ...
        'alumni_mark'            => 'Mark as alumni',
        'alumni_mark_modal'      => 'Mark :name as alumni?',
        'alumni_mark_body'       => 'They come off the public team page and stop counting as active, from today. Their panel account and role are not touched — this is a roster status, not an access change. Reversible.',
        'alumni_marked'          => ':name is now an alumnus.',
        'alumni_marked_bulk'     => ':count member(s) marked as alumni.',
        'alumni_restore'         => 'Back to active',
        'alumni_restore_modal'   => 'Put :name back on the active roster?',
        'alumni_restore_body'    => 'Clears their leaving date, so they appear on the public team page again if they are set to public.',
        'alumni_restored'        => ':name is back on the active roster.',
    ...
    'users' => [
        ...
        'delete_keeps_member_body' => ':name stays on the team members list, but is hidden from the public site and can no longer sign in. Use "Create login" on their row to give them an account again.',
    ...
    'home_content' => [
        ...
        'hero_title1'    => 'Headline, first line',
        'hero_title2'    => 'Headline, second line',
        'hero_lede'      => 'Lede',
        'hero_ctaJoin'     => 'Primary button',
        'hero_ctaMission'  => 'Secondary button',
        'rocket_eyebrow'   => 'Eyebrow line',
        ...
        'manifesto_mark1'  => 'Mark, first',
        'manifesto_mark2'  => 'Mark, second',
        'manifesto_mark3'  => 'Mark, third',
        'sponsors'         => 'Sponsor pitch',
        'sponsors_help'    => 'The panel asking companies to support the team. The logo strip itself is edited under Site → Sponsors.',
        'sponsors_pitchTitle' => 'Pitch heading',
        'sponsors_pitchBody'  => 'Pitch body',
        'sponsors_cta'     => 'Button',
        'join'             => 'Join block',
        'join_help'        => 'The call to action near the bottom of the home page. The application form itself lives under Membership → Application form.',
        'join_eyebrow'     => 'Eyebrow line',
        'join_title'       => 'Heading',
        'join_lede'        => 'Lede',
        'join_cta'         => 'Primary button',
        'join_question'    => 'Secondary link',
        'contact'          => 'Contact',
        'contact_help'     => 'Shown in the footer. The e-mail address is not here — it is a constant in the code, because an address is not translatable content.',
        'contact_address'  => 'Postal address',
        'says'           => 'Scroll statements',
        'says_help'      => 'The lines played one after another as the hero is scrolled through. Three is what the layout was built for; a fourth is fine. Use <em> around the one word that takes the accent.',
        'says_add'       => 'Add a line',
        'line'           => 'Line',
        'rocket'         => 'Rocket sheet',
        'rocket_help'    => 'The section about the current vehicle. The subsystem list and the headcounts come from the roster, not from here.',
        'dim_height'     => 'Height, as drawn on the blueprint',
        'dim_diameter'   => 'Diameter, as drawn on the blueprint',
        'specs'          => 'Spec table',
        'specs_help'     => 'Six rows fill the two columns exactly; fewer leaves a gap, more is ignored by the layout.',
        'specs_add'      => 'Add a row',
        'spec_label'     => 'Label',
        'spec_value'     => 'Value',
        'spec_unit'      => 'Unit',
        'saved'          => 'Home page texts saved.',
    ],
    ...
    'cms' => [
        ...
        'resources'    => 'Resources',
        'project_state'        => 'Stage',
        'project_state_help'   => 'Drives the badge on the public page and how far the progress rail is filled.',
        'project_states'       => ['flown' => 'Flown', 'building' => 'In build', 'design' => 'Design'],
        'project_years'        => 'Years',
        'project_years_help'   => 'As it should read, e.g. "2024 — 2025" or "2027 —".',
        'project_apogee'       => 'Altitude line',
        'project_apogee_help'  => 'Label and figure together, e.g. "Apogee reached · 640 m". Leave empty and the line is left off that card.',
