...
// This container hosts the admin panel + API only — the SPA is served
// separately (Caddy fronts both in the compose stack). Redirect root-URL
// hits to the Filament login so we don't
