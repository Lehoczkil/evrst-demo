    ...
    protected function startAt(): Attribute
    {
        return Attribute::make(
            ...
            set: function ($value) {
                ...
                // landing exactly on a range boundary — an event starting at
                // 00:00 on the 1st — fell outside a whereBetween for its own
                // month, and `?past=true` could miss a row by one minute.
